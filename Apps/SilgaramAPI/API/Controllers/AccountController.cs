...
namespace API.Controllers
{
    [Authorize]
    [BaseApiController]
    [RoutePrefix("Silgaram/api/Account")]
    public class AccountController : ApiController
    {
        ...
        [Route("Logout")]
        private IHttpActionResult Logout()
        {
        ...
        {
            return Json(UsreData.SaveChenage(model));
        }

        /// <summary>
        /// للحصول على كلمة السر ويتم ارسالها الى الاميل
        /// </summary>
        ...
        {
            return Json(UsreData.ForgetPassword(email));
        }
