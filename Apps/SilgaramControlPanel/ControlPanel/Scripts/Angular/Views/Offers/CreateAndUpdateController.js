...
myApp.controller('ctrlOfferCreateAndUpdate', ['$scope', '$http', '$filter', 'serviceOffers', 'serviceView', function (s, h, filter, service, serviceView) {
    ...
    s.Offer = {
        NewImages: [],
        'StartDateTime': new Date(curentDate.getFullYear(), curentDate.getMonth(), curentDate.getDate(), curentDate.getHours(), curentDate.getMinutes()),
        'EndDateTime': new Date(curentDate.getFullYear(), curentDate.getMonth(), curentDate.getDate(), curentDate.getHours(), curentDate.getMinutes())
    };
    //</!--Config-->
    ...
    //Save Change
        s.saveChange = () => {
            ...
            s.Offer.StartDateTime = convertDateTimeToCSharpDateTime(s.Offer.StartDateTime);
            s.Offer.EndDateTime = convertDateTimeToCSharpDateTime(s.Offer.EndDateTime);

        startBlock();
            service.saveChange(s.Offer,s.NewImages).then(d=> {
            co("R-SaveChange", d);
